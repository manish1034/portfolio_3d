...
const About = () => {
  return (
    <>
      {/* midCard */}
      <div className="absolute blue-gradient py-[5rem] px-[3rem] -top-[20%] left-[5%] inset-[3rem] rounded-3xl h-[85vh] lg:w-[87%] md:w-[84%] z-50">   
        <div className="absolute bottom-0 start-0 w-[100%] z-50">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 319">
          <path fill="rgb(5, 8, 22)" fill-opacity="1" d="M0,192L48,186.7C96,181,192,171,288,186.7C384,203,480,245,576,240C672,235,768,181,864,165.3C960,149,1056,171,1152,160C1248,149,1344,107,1392,85.3L1440,64L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path>
        </svg>
        </div>
      </div>
      ...
      {/* aboutSection */}
      <section id='about'>
        <div className='container mx-5 xl:mt-[52vh] lg:mt-[55vh] md:mt-[42vh] sm:mt-[45vh] xs:mt-[45vh]'>
          <div className='flex flex-col lg:flex-row gap-x-10'>
            ...
            <div className='flex-1 flex flex-col gap-y-[2.6rem] lg:gap-y-[4.5rem] xl:gap-y-[6.3rem] mb-10 lg:mb-0'>
              ...
              className='group relative overflow-hidden xl:h-[16.5rem] lg:h-[15rem] xs:h-[12rem] md:h-[17rem] lg:w-[92%] md:w-[78%] sm:w-[88%] xs:w-[88%] rounded-xl shadow-2xl shadow-white/10'>
                ...
                <div className='absolute -bottom-full left-12 group-hover:bottom-14 transition-all duration-700 z-50'>
                  <span className='text-3xl text-white'>Quick Learner</span>
                </div>
              </motion.div>
            </div>
            ...
            <div className='flex-1 flex flex-col gap-y-11 lg:gap-y-[7.8rem] xl:gap-y-[5.5rem] 2xl:gap-y-[4rem]'>
              ...
              className='group relative overflow-hidden xl:h-[16.5rem] lg:h-[14.5rem] xs:h-[12rem] md:h-[17rem] w-[88%] md:w-[79%] lg:w-[88%] lg:mt-5 rounded-xl shadow-2xl shadow-white/5'>
                ...
                <div className='absolute -bottom-full left-12 group-hover:bottom-14 transition-all duration-700 z-50'>
                  <span className='text-3xl text-white'>leadership</span>
                </div>
              </motion.div>
              {/* Card */}
              <motion.div
              variants={fadeIn("left","spring", 1, 1)}
              className='group relative overflow-hidden xl:h-[16.5rem] lg:h-[14rem] xs:h-[12rem] md:h-[17rem] w-[88%] md:w-[79%] lg:w-[88%] rounded-xl shadow-2xl shadow-white/10'>
                <div className='group-hover:bg-black/70 w-full h-full absolute z-40 transition-all duration-300'></div>
                ...
                <div className='absolute -bottom-full left-12 group-hover:bottom-14 transition-all duration-700 z-50'>
                  <span className='text-3xl text-white'>Problem Solving</span>
                </div>
              </motion.div>
